...
class App:
    def __init__(self, window, title, sources):
        ...
        self.simple_image = PIL.Image.open(os.path.join(ROOT, "image", "img_src", "img203.png"))
        ...
        Cam1 = tkCamera(self.window, 0, 0, width, height, sources, text= "Cam toàn cảnh", source=os.path.join(ROOT, "demo", "demo.mp4"))
        self.stream_widgets.append(Cam1)
        
        Cam2 = tkCamera(self.window, 0, 1, width, height, sources, text= "Cam biển số", source=os.path.join(ROOT, "demo", "demo.mp4"))
