...
username = 'DucQuanLP'
password = '123456789'
connection_string = 'Driver={ODBC Driver 18 for SQL Server};Server='+server+';Database='+database+';UID='+username+';PWD='+ password+';Encrypt=no;TrustServerCertificate=yes'

default_time = datetime.datetime(1900, 1, 1, 0, 0, 0, 0)
